<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:64:"E:\phpstudy\WWW\tpfive/admin/admin\view\product\product_add.html";i:1578118507;s:26:"admin/admin/view/head.html";i:1578118507;s:26:"admin/admin/view/left.html";i:1593309925;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8">
		...
		<script>
			...
			a.style.height = text;
									...
									<div class="layui-col-md10 pd15">
										<form id="bd" method="post" action="admin.php?s=admin/product/product_add_js" enctype="multipart/form-data" >
											<div class="layui-col-md12">
												<div class="layui-col-md1 zt">产品名称</div>
												<div class="layui-col-md10"><input type="text" name="tit"  ></div>
											</div>
											<div class="layui-col-md12">
												<div class="layui-col-md1 zt">时间</div>
												<div class="layui-col-md10"><input type="date" name="times"></div>
											</div>
											<div class="layui-col-md12">
												<div class="layui-col-md1 zt">文章图片</div>
												<div class="layui-col-md10"><input type="file" name="photo"></div>
											</div>
											<div class="layui-col-md12">
												<div class="layui-col-md1 zt">产品详细内容</div>
												<script id="editor" type="text/plain" class="layui-col-md10"></script>
