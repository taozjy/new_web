<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:64:"E:\phpstudy\WWW\tpfive/admin/admin\view\abouts\abouts_index.html";i:1593417222;s:26:"admin/admin/view/head.html";i:1578118507;s:26:"admin/admin/view/left.html";i:1593421531;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8">
	...
	<div style="height: 80px; border-bottom: 1px solid #000;" class="layui-row">
		...
		<script>
			...
			a.style.height = text;
					...
					<div style="box-sizing: border-box; padding: 10px;" class="layui-col-md10">
						<form class="layui-col-md12" id="" method="post" action="admin.php?s=admin/abouts/abouts_update"  enctype="multipart/form-data" >
						...
						<div class="layui-col-md2">	<h1>QQ</h1></div>
						<div class="layui-col-md12">&nbsp;</div>
						<div class="layui-col-md12"><input type="text" name="qq" value="<?php echo $texts['qq_text']; ?>" ></div>
						<div class="layui-col-md2"><h1>公司地址</h1></div>
						<div class="layui-col-md12">&nbsp;</div>
						<div class="layui-col-md12"><input type="text" name="address" value="<?php echo $texts['address']; ?>" ></div>
						<div class="layui-col-md2"><h1>ICP编号</h1></div>
						<div class="layui-col-md12">&nbsp;</div>
						<div class="layui-col-md12"><input type="text" name="number" value="<?php echo $texts['number']; ?>" ></div>
						<div class="layui-col-md2"><h1>联系电话</h1></div>
						<div class="layui-col-md12">&nbsp;</div>
						<div class="layui-col-md12"><input type="text" name="photo" value="<?php echo $texts['photo']; ?>" ></div>
						<div class="layui-col-md12">&nbsp;</div>
						...
						<div class="layui-col-md12">&nbsp;</div>
						<form class="layui-col-md12" id="" method="post" action="admin.php?s=admin/abouts/abouts_update_code"  enctype="multipart/form-data" >
						<?php if(is_array($text_sel) || $text_sel instanceof \think\Collection || $text_sel instanceof \think\Paginator): $i = 0; $__LIST__ = $text_sel;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$texts): $mod = ($i % 2 );++$i;?>
							<div class="layui-col-md2"><h1>二维码</h1></div>
							<div class="layui-col-md12">&nbsp;</div>
							<?php if($texts['qr_code_url']==""): ?>
							
							<div class="layui-col-md10"><input type="file" name="qr_code"  ></div>
							
							<?php else: ?>
							<div class="layui-col-md10"><input type="file" name="qr_code"  ></div>
							<div class="layui-col-md12"><img width="100px" height="100px" src="<?php echo $texts['qr_code_url']; ?>" /></div>
							<?php endif; ?>
							<div class="layui-col-md12">&nbsp;</div>
							<input class="layui-col-md2 layui-btn" type="submit" value="提交" />
						<?php endforeach; endif; else: echo "" ;endif; ?>
