<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:60:"E:\phpstudy\WWW\tpfive/admin/admin\view\textwb\text_add.html";i:1578118507;s:26:"admin/admin/view/head.html";i:1578118507;s:26:"admin/admin/view/left.html";i:1593421531;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8">
		...
		<script>
			...
			a.style.height = text;
							...
							<div class="layui-col-md10 pd15">
								<form id="bd" method="post" action="admin.php?s=admin/textwb/text_add_js" enctype="multipart/form-data" >
									<div class="layui-col-md12">
										<div class="layui-col-md1 zt">标题</div>
									...
									<div class="layui-col-md12">
										...
										<div class="layui-col-md10"><input type="text" name="photo"></div>
									</div>
									<div class="layui-col-md12">
										<div class="layui-col-md1 zt">标题</div>
