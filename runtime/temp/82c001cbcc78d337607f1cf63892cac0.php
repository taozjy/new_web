<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:68:"E:\phpstudy\WWW\tpfive/admin/admin\view\banner\banner_add_false.html";i:1578118508;s:26:"admin/admin/view/head.html";i:1578118507;s:26:"admin/admin/view/left.html";i:1593421531;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8">
		...
		<script>
			...
			a.style.height = text;
						...
						<div  class="layui-col-md10 pd15">
								<form method="post" action="admin.php?s=admin/banner/banner_add_true" enctype="multipart/form-data" >
									<div class="layui-col-md10 " >
										<div class="layui-col-md12 ">
											<div class="layui-col-md2 zt hg28">上传图片</div>
											<div class="layui-col-md6 "><input name="photo" type="file"></div>
										</div>
										<div class="layui-col-md12 ">
											<div class="layui-col-md2 zt hg28">网址链接</div>
											<div class="layui-col-md6" ><input name="hrefs" type="text"></div>
										</div>
										<div class="layui-col-md12 ">
											<div class="layui-col-md2 zt hg28">是否显示</div>
