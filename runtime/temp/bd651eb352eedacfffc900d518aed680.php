<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:59:"E:\phpstudy\WWW\tpfive/application/index\view\nr\index.html";i:1593494685;s:53:"E:\phpstudy\WWW\tpfive\application\index\view\mb.html";i:1593403057;s:32:"application/index/view/head.html";i:1593498773;s:32:"application/index/view/foot.html";i:1593418610;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8">
						...
						<div class="layui-col-md12 layui-col-xs12 jz ">
							<?php if(is_array($chanpin) || $chanpin instanceof \think\Collection || $chanpin instanceof \think\Paginator): $i = 0;$__LIST__ = is_array($chanpin) ? array_slice($chanpin,0,4, true) : $chanpin->slice(0,4, true); if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$qtcp): $mod = ($i % 2 );++$i;?>
								...
								<div class="layui-col-md12 layui-col-xs12 ">&nbsp;</div>
									<a class="layui-col-xs12" href="index.php?s=index/nr/index&id=<?php echo $qtcp['id']; ?>">
