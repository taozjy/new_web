<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:56:"E:\phpstudy\WWW\tpfive/admin/admin\view\tit\tit_add.html";i:1593497964;s:26:"admin/admin/view/head.html";i:1578118507;s:26:"admin/admin/view/left.html";i:1593421531;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8">
						  ...
						  <div class="layui-tab-content">	
									<div class="layui-tab-item layui-show">
										<div class="layui-col-md12 layui-col-md-offset1">
											...
											<div class="layui-col-md2">所属控制器</div>
										</div>
										<div class="layui-col-md12 layui-col-md-offset1">&nbsp;</div>
										
										
										<form method="post" action="admin.php?s=admin/tit/tit_add_js" enctype="multipart/form-data">
