<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:65:"E:\phpstudy\WWW\tpfive/admin/admin\view\textwb\update_textwb.html";i:1578118507;s:26:"admin/admin/view/head.html";i:1578118507;s:26:"admin/admin/view/left.html";i:1593309925;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8">
		...
		<script>
			...
			a.style.height = text;
							...
							<div class="layui-col-md10 pd15">
								<form id="bd" method="post" action="admin.php?s=admin/textwb/update_textwbs" enctype="multipart/form-data" >
									<div class="layui-col-md12">
										<div class="layui-col-md1">标题</div>
										<div class="layui-col-md10"><input type="text" name="tit" value="<?php echo $text[0]['index_text_name']; ?>"  ></div>
									</div>
									<div class="layui-col-md12">
										<div class="layui-col-md1">时间</div>
										<div class="layui-col-md10"><input type="date" name="times" value="<?php echo $text[0]['index_text_time']; ?>"></div>
									</div>
									...
									<div class="layui-col-md12">
										...
										<script id="editor" type="text/plain" class="layui-col-md10">
											<?php echo $text[0]['index_text_text']; ?>
										</script>
