<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:66:"E:\phpstudy\WWW\tpfive/admin/admin\view\product\product_index.html";i:1578118507;s:26:"admin/admin/view/head.html";i:1578118507;s:26:"admin/admin/view/left.html";i:1593421531;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8">
		...
		<script>
			...
			a.style.height = text;
							...
							<div class="layui-col-md10 pd15">
								<a class="layui-col-md1 layui-btn" href="admin.php?s=admin/product/Product_add">新增</a>
								<div class="layui-col-md12">&nbsp</div>
								<ul class="layui-col-md12">
								<li class="layui-col-md1 biaoti">排序</li>
								<li class="layui-col-md4 biaoti">作品名称</li>
								<li class="layui-col-md2 biaoti">产品时间</li>
								<li class="layui-col-md2 biaoti">操作</li>
								</ul>
								<div class="layui-col-md12">&nbsp</div>
								<?php if(is_array($product_sel) || $product_sel instanceof \think\Collection || $product_sel instanceof \think\Paginator): $i = 0; $__LIST__ = $product_sel;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$product_sel): $mod = ($i % 2 );++$i;?>
									<ul class="layui-col-md12 jz1">
										<li class="layui-col-md1"><?php echo $product_sel['id']; ?></li>
										<li class="layui-col-md4"><?php echo $product_sel['product_name']; ?></li>
										<li class="layui-col-md2"><?php echo $product_sel['time']; ?></li>
										<li class="layui-col-md2">
											<a class="layui-btn" href="admin.php?s=admin/product/product_update&id=<?php echo $product_sel['id']; ?>">修改</a>
											&nbsp;
											<a class="layui-btn" href="admin.php?s=admin/product/product_detele&id=<?php echo $product_sel['id']; ?>">删除</a>
										</li>
									</ul>
									<div class="layui-col-md12">&nbsp</div>
